CREATE TABLE IF NOT EXISTS "users" (
    ...
    uuid VARCHAR(255) DEFAULT NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS "categories" (
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, -- Automatically updated on changes
...
CREATE TABLE IF NOT EXISTS "stores" (
    ...
    image_id BIGINT, -- Foreign key to the "attachments" table
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "products" (
    ...
    image_id BIGINT, -- Foreign key to the "attachments" table
    category_id BIGINT, -- Foreign key to the "categories" table
    store_id BIGINT NOT NULL, -- Foreign key to the "stores" table
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, -- Automatically set on creation
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, -- Automatically updated on changes
    FOREIGN KEY (image_id) REFERENCES "attachments" (id) ON DELETE SET NULL,
...
INSERT INTO products (id, name, description, coupon, url, price, category_id, store_id, created_at,image_id)
VALUES
  (1, 'Apple Watch Series 8', 'Premium smartwatch with advanced health features.', 'WATCH20', 'https://www.apple.com/watch-series-8', 499.00, 17, 8, current_timestamp,3),
  (2, 'Magic Keyboard with Touch ID and Numeric Keypad', 'Sleek keyboard with built-in fingerprint sensor.', 'KEYBOARD10', 'https://www.apple.com/magic-keyboard', 149.00, 19, 2, current_timestamp,2),
  (3, 'iRobot Roomba i7+ (E5154)', 'Self-emptying robotic vacuum cleaner.', 'VACUUM5', 'https://www.irobot.com/en-us/roomba/i7', 799.00, 21, 3, current_timestamp,4),
  (4, 'Sony WH-1000XM5', 'Industry-leading noise-canceling headphones.', 'AUDIO25', 'https://www.sony.com/electronics/headphones/wh-1000xm5', 399.00, 12, 4, current_timestamp,5),
  (5, 'Logitech MX Master 3S', 'High-performance wireless mouse with excellent ergonomics.', 'MOUSE15', 'https://www.logitech.com/en-us/products/mice/mx-master-3s.html', 99.99, 19, 5, current_timestamp,6),
  (6, 'Apple AirTag (4-pack)', 'Bluetooth trackers to locate your belongings.', 'FINDIT10', 'https://www.apple.com/airtag', 99.00, 10, 5, current_timestamp,7),
  (7, 'Garmin Vivosmart 5', 'Fitness tracker with advanced health monitoring.', 'SCALE20', 'https://www.garmin.com/en-US/p/678739', 149.00, 17, 3, current_timestamp,8),
  (8, 'Arlo Pro 4 Spotlight Camera', 'Wireless security camera with powerful spotlight.', 'SECURE5', 'https://www.arlo.com/en-us/products/arlo-pro-4-spotlight-camera', 249.00, 10, 5, current_timestamp,9),
  (9, 'Anker 521 Magnetic Portable Charger', 'Compact and powerful portable charger for iPhones.', 'MAGSAFE15', 'https://www.anker.com/products/anker-521-magnetic-portable-charger', 59.99, 19, 2, current_timestamp,10),
  (10, 'Nintendo Switch OLED Model', 'Portable gaming console with vibrant display.', 'SWITCH10', 'https://www.nintendo.com/switch', 349.99, 5, 5, current_timestamp,11),
  (11, 'Samsung T7 Shield', 'Rugged and portable SSD for fast data transfer.', 'SSD20', 'https://www.samsung.com/us/mobile-storage/t7-shield', 99.99, 19, 1, current_timestamp,12),
  (12, 'Dyson V15 Detect', 'Powerful cordless vacuum with laser dust detection.', 'PVACUUM15', 'https://www.dyson.com/v15-detect', 699.00, 21, 7, current_timestamp,13),
  (13, 'Apple Watch SE', 'Affordable smartwatch with essential features.', 'WATCH5', 'https://www.apple.com/watch-se', 249.00, 17, 8, current_timestamp,14),
  (14, 'Samsung Galaxy Tab S8', 'High-performance Android tablet with stunning display.', 'TAB10', 'https://www.samsung.com/us/tablets/galaxy-tab-s8', 699.00, 4, 4, current_timestamp,15),
  (15, 'Apple MacBook Air (M2)', 'Lightweight and powerful laptop with M2 chip.', 'LAPTOP15', 'https://www.apple.com/macbook-air', 1199.00, 3, 7, current_timestamp,16),
  (16, 'Bose SoundLink Flex', 'Portable Bluetooth speaker with rugged design.', 'SPEAKER20', 'https://www.bose.com/en_us/products/speakers/portable-speakers/soundlink-flex.html', 149.00, 12, 6, current_timestamp,17),
  (17, 'LG C2 Series OLED TV', 'Exceptional picture quality with OLED technology.', 'TV10', 'https://www.lg.com/us/tvs/lg-c2-series-oled-tv', 1499.00, 8, 2, current_timestamp,18),
  (18, 'DJI Mini 3 Pro', 'Compact and powerful drone with 4K video recording.', 'DRONE5', 'https://www.dji.com/mini-3-pro', 699.00, 11, 1, current_timestamp,19),
  (19, 'Samsung Galaxy Buds2 Pro', 'Premium wireless earbuds with excellent sound quality.', 'EARBUDS15', 'https://www.samsung.com/us/audio/galaxy-buds2-pro', 199.00, 12, 3, current_timestamp,20),
  (20, 'PlayStation 5', 'Powerful gaming console with stunning graphics.', 'CONSOLE10', 'https://www.playstation.com/en-us/ps5', 499.00, 5, 8, current_timestamp,21),
  (21, 'BenQ TK800M', 'Home theater projector with 4K HDR support.', 'PROJECTOR20', 'https://www.benq.com/en-us/projector/home-theater/tk800m.html', 1999.00, 8, 4, current_timestamp,22),
  (22, 'Instant Pot Duo Crisp + Air Fryer', 'Multi-cooker with air frying capabilities.', 'POT15', 'https://www.instantpot.com/duo-crisp-air-fryer', 149.95, 21, 6, current_timestamp,23),
  (23, 'Vitamix A2300', 'High-performance blender for smoothies and more.', 'BLEND10', 'https://www.vitamix.com/blenders/a2300', 449.00, 21, 1, current_timestamp,24),
  (24, 'Breville Precision Brewer Thermal', 'Coffee maker that brews coffee to the perfect temperature.', 'COFFEE5', 'https://www.brevilleusa.com/us/en/products/coffee-and-specialty/precision-brewer-thermal.html', 299.00, 21, 5, current_timestamp,25),
  (25, 'Philips Sonicare DiamondClean 9000', 'High-end electric toothbrush with advanced sonic technology.', 'TOOTHBRUSH15', 'https://www.philips.com/en-us/c-p/oral-care/sonicare-diamondclean-9000-hx9911/91/product-details', 299.00, 9, 2, current_timestamp,26),
  (26, 'Coway Airmega 400S', 'High-performance air purifier for large rooms.', 'AIR10', 'https://www.cowayusa.com/airmega-400s', 499.00, 21, 7, current_timestamp,27),
  (27, 'Nest Learning Thermostat', 'Smart thermostat that learns your preferences.', 'THERMOSTAT5', 'https://www.google.com/nest/thermostat', 129.00, 21, 3, current_timestamp,28),
  (28, 'iRobot Roomba j7+', 'Robotic vacuum that avoids obstacles.', 'ROBOT5', 'https://www.irobot.com/en-us/roomba/j7', 899.00, 21, 6, current_timestamp,29),
  (29, 'Fitbit Charge 5', 'Fitness tracker with built-in GPS and stress management tools.', 'FITNESS10', 'https://www.fitbit.com/us/en/products/charge-5', 149.95, 17, 1, current_timestamp,30),
  (30, 'Bose QuietComfort Earbuds II', 'Premium noise-canceling earbuds with improved sound quality.', 'HEADPHONES5', 'https://www.bose.com/',254.3,12,6, current_timestamp,31),
  (31, 'Apple iPhone 14 Pro', 'Flagship smartphone with pro-level camera system.', 'IPHONE15', 'https://www.apple.com/iphone-14-pro', 999.00, 2, 8, current_timestamp,32),
  (32, 'Samsung Galaxy S23 Ultra', 'Powerful Android smartphone with impressive zoom capabilities.', 'GALAXY10', 'https://www.samsung.com/us/smartphones/galaxy-s23-ultra', 1199.00, 2, 1, current_timestamp,33),
  (33, 'Google Pixel 7 Pro', 'Excellent smartphone with the best Android experience.', 'PIXEL5', 'https://store.google.com/us/product/pixel_7_pro', 899.00, 2, 3, current_timestamp,34),
  (34, 'Apple MacBook Pro 14', 'High-performance laptop with M2 Pro chip.', 'MBP15', 'https://www.apple.com/macbook-pro-14', 1999.00, 3, 7, current_timestamp,35),
  (35, 'Dell XPS 13 Plus', 'Premium ultrabook with a sleek and modern design.', 'DELL10', 'https://www.dell.com/en-us/shop/laptops/xps/xps-13-plus/spd/xps-13-plus-laptop', 1499.00, 3, 2, current_timestamp,36),
  (36, 'Lenovo Legion 5 Pro', 'Powerful gaming laptop for demanding titles.', 'LEGION15', 'https://www.lenovo.com/us/en/p/laptops/legion-laptops/legion-5-pro/legion-5-pro-16ach6h/product.html', 1699.00, 3, 5, current_timestamp,37),
  (37, 'Samsung Galaxy Tab S9+', 'High-end Android tablet with stunning display.', 'TAB20', 'https://www.samsung.com/us/tablets/galaxy-tab-s9', 899.00, 4, 6, current_timestamp,38),
  (38, 'iPad Pro 12.9-inch', 'Powerful tablet for creative professionals.', 'IPAD15', 'https://www.apple.com/ipad-pro', 1099.00, 4, 8, current_timestamp,39),
  (39, 'PlayStation 5 Digital Edition', 'Powerful gaming console with no disc drive.', 'PS5D10', 'https://www.playstation.com/en-us/ps5', 399.00, 5, 1, current_timestamp,40),
  (40, 'Logitech G Pro X Superlight', 'Lightweight and high-performance gaming mouse.', 'GPRO5', 'https://www.logitechg.com/en-us/products/gaming-mice/g-pro-x-superlight.html', 149.99, 5, 4, current_timestamp,41),
  (41, 'VanMoof S5', 'High-tech electric bike with integrated theft prevention.', 'VAMOOF10', 'https://www.vanmoof.com/en_US/s5', 3498.00, 6, 2, current_timestamp,42),
  (42, 'Rad Power Bikes RadRunner 2', 'Versatile electric bike for cargo and commuting.', 'RAD20', 'https://www.radpowerbikes.com/products/radrunner-2', 1499.00, 6, 3, current_timestamp,43),
  (43, 'Anycubic Vyper', 'Easy-to-use 3D printer for beginners.', '3DPRINT15', 'https://www.anycubic.com/products/vyper', 269.00, 7, 5, current_timestamp,44),
  (44, 'Creality Ender 3 S1 Pro', 'Popular 3D printer with excellent print quality.', 'ENDER10', 'https://www.creality.com/products/ender-3-s1-pro', 399.00, 7, 6, current_timestamp,45),
  (45, 'Sony Bravia XR A95K OLED', 'Top-of-the-line OLED TV with stunning picture quality.', 'TV20', 'https://www.sony.com/electronics/tvs/a95k/overview', 3999.00, 8, 7, current_timestamp,46),
  (46, 'BenQ TK850i', '4K HDR projector for home theater enthusiasts.', 'PROJECTOR15', 'https://www.benq.com/en-us/projector/home-theater/tk850i.html', 2999.00, 8, 2, current_timestamp,47),
  (47, 'Philips Norelco OneBlade', 'Versatile grooming tool for face and body.', 'ONEBLADE10', 'https://www.usa.philips.com/c-p/grooming/oneblade-face-body/oneblade-pro-qp2630-40/91/product-details', 49.99, 9, 1, current_timestamp,48),
  (48, 'Foreo Luna 3', 'Facial cleansing and massage device.', 'LUNA15', 'https://www.foreo.com/us/luna-3', 199.00, 9, 4, current_timestamp,49),
  (49, 'Ring Video Doorbell 4', 'Smart doorbell with HD video and two-way audio.', 'RING10', 'https://www.ring.com/products/doorbell-4', 199.00, 10, 3, current_timestamp,50),
  (50, 'Arlo Pro 4', 'Wireless security camera system with advanced features.', 'ARLO15', 'https://www.arlo.com/en-us/products/arlo-pro-4', 499.00, 10, 6, current_timestamp,51),
  (51, 'DJI Mavic 3', 'High-end drone with incredible camera capabilities.', 'MAVIC10', 'https://www.dji.com/mavic-3', 2199.00, 11, 5, current_timestamp,52),
  (52, 'Holy Stone HS720E', 'Affordable drone with 4K camera for beginners.', 'HS720E5', 'https://www.amazon.com/Holy-Stone-HS720E-Foldable-Quadcopter/dp/B07Q9F8G8S', 129.99, 11, 8, current_timestamp,53),
  (53, 'Bose QuietComfort Earbuds III', 'Premium noise-canceling earbuds with improved sound quality.', 'BOSE15', 'https://www.bose.com/en_us/products/headphones/earbuds/quietcomfort-earbuds-ii.html', 299.00, 12, 1, current_timestamp,54),
  (54, 'Sony SRS-XB43', 'Portable Bluetooth speaker with powerful sound.', 'SONYXB10', 'https://www.sony.com/electronics/speakers/srs-xb43', 199.00, 12, 4, current_timestamp,55),
